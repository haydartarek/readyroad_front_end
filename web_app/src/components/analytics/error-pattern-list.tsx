            ...
            <CardContent className="px-6 py-5 space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {pattern.exampleQuestions.length >
                          ...
                          <Badge variant="outline" className="text-xs">
                            {t("error_patterns.more_questions").replace(
                              "{n}",
                              String(
                                pattern.exampleQuestions.length -
                                  MAX_VISIBLE_QUESTIONS,
              ...
              {!isExpanded && (
                <Button
                  ...
                  size="sm"
                  className={cn(
                    "w-full gap-2 rounded-xl font-semibold border",
                    cfg.border,
                    cfg.text,

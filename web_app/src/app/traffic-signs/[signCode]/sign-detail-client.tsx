...
export default function TrafficSignDetailClient({
  initialSign,
  ...
  const [sign, setSign] = useState<TrafficSign | null>(initialSign);
  const [signProgress, setSignProgress] = useState<SignUserProgress | null>(
    null,
  );
  const [loading, setLoading] = useState(initialSign === null);
  ...
  }, [fetchKey, initialSign, requestedCode]);

          ...
          >
            ...
            <CardContent className="space-y-5">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {[
                  {
                    label: t("analytics.stat_correct"),
                    value: area.correctCount,
                    color: "text-secondary",
                  },
                  {
                    label: t("analytics.stat_wrong"),
                    value: area.totalCount - area.correctCount,
                    color: "text-destructive",
                  },
                  {
                    label: t("analytics.stat_estimated_time"),

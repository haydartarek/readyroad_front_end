...
export const APP_URL = process.env.NEXT_PUBLIC_APP_URL || "https://readyroad.be";
const OG_IMAGE = { url: "/images/og.png", width: 1200, height: 630, alt: "ReadyRoad – Belgian Driving License Exam Prep" };
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Practice Belgian theory tests, study 250+ traffic signs, and track your progress. Available in 4 languages.",
    type:        "website",
    url:         APP_URL,
    siteName:    "ReadyRoad",
    locale:      "en_BE",
  ...
  twitter: {
    ...
    creator:     "@ReadyRoad",
    title:       "ReadyRoad | Belgian Driving License Exam Prep",
    description: "Practice theory tests, study 250+ traffic signs & track your progress. Available in 4 languages.",
    images:      [OG_IMAGE.url],
  },
...
const organizationSchema = {
  ...
  description:  "ReadyRoad is the #1 platform to prepare for the Belgian driving license theory exam, available in 4 languages: English, Nederlands, Français & العربية.",
  sameAs: [
    "https://readyroad.be",
  ],
  areaServed: {
...
const websiteSchema = {
  ...
  url:           APP_URL,
  name:          "ReadyRoad",
  description:   "Belgian driving license exam preparation platform in 4 languages.",
  publisher: {
    "@id": `${APP_URL}/#organization`,
  },
  potentialAction: {
...
const educationalAppSchema = {
  ...
  operatingSystem:  "Web",
  url:               APP_URL,
  description:       "Prepare for the Belgian driving license exam with practice tests, 250+ traffic signs, theory lessons and progress analytics.",
  offers: {
    "@type":         "Offer",
    price:           "0",
    priceCurrency:   "EUR",

...
export const metadata: Metadata = {
  ...
  keywords: [
    "contact ReadyRoad",
    "ReadyRoad support",
    "rijbewijs app contact",
    "contact rijbewijs oefenen",
    "contact permis conduire belgique",
    "تواصل ReadyRoad",
    "دعم رخصة القيادة بلجيكا",
  ],
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Get in touch with the ReadyRoad team. We are here to help you prepare for the Belgian driving exam.",
    url: `${APP_URL}/contact`,
    siteName: "ReadyRoad",
    locale: "en_BE",
    images: [

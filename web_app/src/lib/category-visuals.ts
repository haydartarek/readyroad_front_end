...
export const CATEGORY_VISUALS: Record<string, CategoryVisual> = {
  ...
  B: {
    icon: Diamond,
    iconWrap:
      "bg-gradient-to-br from-amber-500 to-yellow-500 ring-amber-200/80",
    iconTone: "text-white",
  ...
  F: {
    icon: SignpostBig,
    iconWrap:
      "bg-gradient-to-br from-emerald-500 to-teal-500 ring-emerald-200/80",
    iconTone: "text-white",
  ...
  FM: {
    icon: Route,
    iconWrap:
      "bg-gradient-to-br from-orange-500 to-amber-500 ring-orange-200/80",
    iconTone: "text-white",
  ...
  T: {
    icon: Navigation,
    iconWrap:
      "bg-gradient-to-br from-violet-500 to-indigo-500 ring-violet-200/80",
    iconTone: "text-white",
  ...
  Z: {
    icon: MapPinned,
    iconWrap:
      "bg-gradient-to-br from-fuchsia-500 to-violet-500 ring-fuchsia-200/80",
    iconTone: "text-white",

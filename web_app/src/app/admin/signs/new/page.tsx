...
export default function AdminAddSignPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setToast({
        message:
          t("admin.signs.form.create_success") || "Sign created successfully",
        type: "success",
      });
      ...
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        <AdminSectionCard title={t("admin.signs.form.basic_info")}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label
                htmlFor="admin-sign-new-category"
                className="block text-xs font-semibold text-foreground"
              >
              ...
              >
                <option value="">
                  {t("admin.signs.form.select_category")}
                </option>
                {categories.map((cat) => (

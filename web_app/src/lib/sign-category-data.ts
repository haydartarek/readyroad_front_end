...
export const GROUP_INFO: Record<string, GroupInfo> = {
  ...
  M: {
    ...
    description: {
      ...
      en: 'M-series supplementary panels provide specific additional information for cyclists, moped riders, speed pedelecs and other light road users. They are always placed below a main sign and clarify how that sign applies to these groups.',
      ar: 'لافتات السلسلة م هي لوحات تكميلية تقدم معلومات إضافية محددة لراكبي الدراجات والدراجات البخارية والدراجات الكهربائية وغيرهم من مستخدمي الطريق الخفيفين. توضع دائماً أسفل لافتة رئيسية وتوضح كيفية تطبيقها على هذه الفئات.',
      fr: "Les panneaux complémentaires de série M fournissent des informations supplémentaires spécifiques pour les cyclistes, les conducteurs de cyclomoteurs, les speed pedelecs et autres usagers légers. Ils sont toujours placés sous un panneau principal et précisent comment ce panneau s'applique à ces groupes.",
    },
  },
  T: {
    title: {

...
const PERFORMANCE_TIERS: PerformanceTier[] = [
  {
    minAccuracy: 90,
    titleKey: "practice.outstanding",
    descKey: "practice.outstanding_desc",
    color: "text-green-700",
  },
  {
    minAccuracy: 75,
    titleKey: "practice.good_job",
    descKey: "practice.good_job_desc",
    color: "text-blue-700",
  },
  {
    minAccuracy: 50,
    titleKey: "practice.keep_practicing",
    descKey: "practice.keep_practicing_desc",
    color: "text-orange-700",
  },
  {
    minAccuracy: 0,
    titleKey: "practice.more_study",
    descKey: "practice.more_study_desc",
    color: "text-red-700",
  },
];
...
const NEXT_STEPS = [
  ...
  { href: "/exam", labelKey: "practice.take_exam" },
  {
    ...
    labelKey: "practice.view_analytics",
  },
] as const;
...
export function PracticeComplete({
  ...
  const tier =
    PERFORMANCE_TIERS.find((p) => accuracy >= p.minAccuracy) ??
      ...
      <div className="space-y-6">
        ...
        <div className="text-center">
          ...
          <h1 className="text-4xl font-black">
            {isPassing
              ? t("practice.excellent_work")
              : t("practice.practice_complete")}
          </h1>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <StatBox
                ...
                label={t("practice.total_label")}
                className="bg-muted"
              />
              <StatBox
                value={correctAnswers}
                label={t("practice.correct_label")}
                className="bg-green-50 text-green-600"
              />
              <StatBox
                value={wrongAnswers}
                label={t("practice.wrong_label")}
